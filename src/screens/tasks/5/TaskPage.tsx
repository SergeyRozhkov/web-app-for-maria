    ...
    <Box height={'100%'} display={'flex'} justifyContent={"space-around"} pt={8}>
      ...
      <Box display={'flex'} flexDirection={'column'} justifyContent={'space-between'} width={1200} minHeight={500}>
        <Box display={'flex'} flexDirection={'column'}>
          <Box>
            <Typography variant={'h3'} fontWeight={'700'}>{!playState.isRead ? 'Прочита́й текст.' : 'Подбери́ коне́ц для т́екста.'}</Typography>
          </Box>
          <Box pt={4}>
            <Typography display={'inline'} variant={'h5'}>
              {!playState.showTextRest ? 'Вова́ ката́лся на велосипе́де. К Во́ве подлете́ла воро́на. Ма́льчик испуга́лся и вре́зался в ка́мень. … .' : 'Вова́ ката́лся на велосипе́де. К Во́ве подлете́ла воро́на. Ма́льчик испуга́лся и вре́зался в ка́мень. Во́ва упа́л с велосипе́да.'}
            </Typography>
          </Box>
          {playState.isRead && (
